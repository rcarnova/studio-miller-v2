        ...
        {p.videoId ? (
          ...
          <div className="reveal aspect-[16/9] w-full bg-secondary overflow-hidden flex items-center justify-center">
            <img
              ...
              loading="lazy"
              className={`w-full h-full ${p.slug === "caritas-fibrilla" || p.slug === "villa-cingoli-rebranding" || p.slug === "pisani-italian-dream" || p.slug === "samsung-galaxy-zflip-sero" || p.slug === "dolciaria-valtellinese-rebranding" || p.slug === "upo-speak4nature" || p.slug === "imeas-brand-strategy" ? "object-cover" : "object-contain p-8 md:p-16"}`}
            />
          </div>
        ) : (
