          ...
          {thumb ? (
            <>
              <img
                ...
                loading="lazy"
                className={`absolute inset-0 w-full h-full ${isVideo ? "object-cover" : project.slug === "caritas-fibrilla" ? "object-cover" : "object-contain p-6"} ${project.slug === "caritas-fibrilla" ? "" : ""} transition-transform duration-700 group-hover:scale-[1.03]`}
              />
              {isVideo && (
                <>
