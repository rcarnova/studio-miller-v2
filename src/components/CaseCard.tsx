          ...
          {thumb ? (
            <>
              <img
                ...
                loading="lazy"
                className={`absolute inset-0 w-full h-full ${isVideo || project.slug === "caritas-fibrilla" || project.slug === "villa-cingoli-rebranding" || project.slug === "pisani-italian-dream" || project.slug === "samsung-galaxy-zflip-sero" || project.slug === "dolciaria-valtellinese-rebranding" ? "object-cover" : "object-contain p-6"} transition-transform duration-700 group-hover:scale-[1.03]`}
              />
              {isVideo && (
                <>
