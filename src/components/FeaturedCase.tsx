          ...
          {thumb ? (
            <>
              <img
                ...
                loading="lazy"
                className={`absolute inset-0 w-full h-full ${isVideo ? "object-cover" : "object-contain p-8 md:p-16"} ${project.slug === "caritas-fibrilla" ? "-rotate-45" : ""} transition-transform duration-[1200ms] ease-out group-hover:scale-[1.04]`}
              />
              {isVideo && (
                <>
