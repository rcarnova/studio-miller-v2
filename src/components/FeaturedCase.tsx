          ...
          {thumb ? (
            <>
              <img
                ...
                loading="lazy"
                className={`absolute inset-0 w-full h-full ${isVideo ? "object-cover" : project.slug === "caritas-fibrilla" ? "object-cover -rotate-90 scale-150" : "object-contain p-8 md:p-16"} transition-transform duration-[1200ms] ease-out group-hover:scale-[1.04]`}
              />
              {isVideo && (
                <>
